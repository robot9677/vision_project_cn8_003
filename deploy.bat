...
rem ============================================================
rem Daol Vision - Safe Deploy Script v2
...
set "BOARD_NAME=CN8-003"
set "TARGET=robot96@100.112.29.16"
